...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("sprinkles",0.25, new ArrayList<>(Arrays.asList("sugar")));
        Topping topping2 = new Topping("gummy bears",0.75, new ArrayList<>(Arrays.asList("sugar")));
        Topping topping3 = new Topping("chocolate chips",0.25, new ArrayList<>(Arrays.asList("chocolate")));
        Topping topping4 = new Topping("crushed oreos",1.25, new ArrayList<>(Arrays.asList("sugar")));
        Topping topping5 = new Topping("nuts",0.25, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping6 = new Topping("crushed peanut butter cups",0.25, new ArrayList<>(Arrays.asList("peanuts")));
        Topping topping7 = new Topping("cherries",0.25, new ArrayList<>(Arrays.asList("cherries")));
